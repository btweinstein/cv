...
\begin{itemize}
\resitem{Delivered an API Gateway software protoype to the Chief Data and Artificial Intelligence Office (CDAO) in response to a quick-turn two week request}
\end{itemize}

\item \award{Trailblazer Award: Digital Twin JWICS deployment}{May 2022}
\begin{itemize}
\resitem{Linked a next-gen command and control (C2) software prototype to a classified dashboard using a series of Open APIs, and demonstrated this capability during MITRE's Research and Technology (R\&T) showcase to hundreds of government sponsors}
\end{itemize}

\item \award{Trailblazer Award: Self Forming Kill Chains Analysis}{May 2021}
\begin{itemize}
\resitem{Executed analyses showing the benefit of novel decision aids at the army tactical level in partnership with OUSD R\&E, Army Futures Command, and MIT Lincoln Labs}
\end{itemize}

\item \award{Breakthrough Award: Chief's Challenge Prototype}{July 2020}\begin{itemize}
\resitem{Rapidly created an exemplar C2 prototype for the Air Force Secretary of Defense under a tight deadline}
\end{itemize}
