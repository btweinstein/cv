...
\item Maintained interim security clearance
\item Helped to point the Functional Architecture in the correct direction
\end{itemize}     
...
\item \ressubheading{Interim Secret Clearance}{MITRE, Bedford MA}{Active}{September 2018}
