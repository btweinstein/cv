...
\usepackage{fancyhdr}
\usepackage[backend=biber,sorting=ydnt,style=numeric,minbibnames=2]{biblatex}
%\usepackage{natbib}
...
\begin{itemize}
\resitem{Recruited many students for MITRE at career fairs through academic engagement, and drew people to CUIC team (at least 3 people hired or interned; Nathan Einstein, Min Kim, Kevin Weinstein). Played an active role on many interview panels.}
...
\resitem{Identified that the technical approach to enable experimentation for the MDC2 Functional Architecture project did not seem to be working and consequently led a small team with a very tight deadline to recreate it in AFSIM. The approach seems to be bearing fruit, and we are able to conduct experiments. Hopefully we will be able to get operators in the loop to play with the prototype.}
\resitem{Worked with individuals outside CUIC to pioneer the approach to link AFSIM to Reinforcement Learning algorithms to enable machine learning experimentation.}
...
\resitem{Created a Python software package utilizing the MAKO templating language to change many parameters in AFSIM experiments.}
\resitem{Created a Python library to simulate abstract wargames for the BIGMAC project}
\resitem{Created a repository of unclassified blue platforms in AFSIM that are used throughout CUIC to support AFSIM experimentation and may be distributed outside of MITRE. More generally, helped maintain and develop synergy between members of CUIC by developing and maintaining online repositories}
\end{itemize}     
...
\item \ressubheading{Fairport High School}{Fairport, NY}{High School}{May 2012}
\begin{itemize}
\resitem{GPA: 98.7/100, Class Valedictorian of 598 students}
\end{itemize}
...
\resheading{Graduate Fellowships and Awards}
...
\resheading{Certifications / Clearances}
...
\item \ressubheading{Secret Clearance}{MITRE, Bedford MA}{Active}{September 2018}
\item \ressubheading{Interim Top Secret Clearance}{MITRE, Bedford MA}{Active}{April 2018}
...
\begin{itemize}
\item \ressubheading{Introduction to Applied Mathematics}{Harvard University}{Teaching Fellow}{September -- May 2016}

\begin{itemize}
\item Undergraduate course taught by Christopher Rycroft. I obtained a 4.86/5.00 on teaching reviews
\item Won a teaching award, the Certificate of Distinction in Teaching from the Bok Center, for the high teaching reviews
\end{itemize}

\item \ressubheading{Statistical Physics}{Harvard University}{Teaching Fellow}{Fall 2017}
\begin{itemize}
\item Graduate course taught by David Nelson, my PhD advisor. I obtained a 4.35/5.00 on teaching reviews
\end{itemize}
...
\begin{itemize}
\item \ressubheading{Adopt a Physicist}{\url{https://www.adoptaphysicist.org/}}{Classroom Discussion Facilitator}{October 2018}
\begin{itemize}
\item Answered questions about being a physicist to high school physics classes in an online forum
\item Helped make students excited about physics
\end{itemize}


\item \ressubheading{\href{https://www.steminspiration.org/about-us}{STEM Inspiration Organization (SIO)}}{Newton, MA}{Interview}{October 2018}
\begin{itemize}
\item Participated in hour long interview to organization supporting high school students interesting in pursuing careers in STEM fields
\item Discussed my career trajectory and life lessons that I learned along the way
\item Transcript of interview can be seen \href{https://www.steminspiration.org/single-post/2018/10/23/Leaders-in-STEM-Interview-Publication-October-2018}{here}
\end{itemize}

\item
        \ressubheading{Science in the News Presentation}{Cambridge, MA}{Physics of Evolution}{November 2014}
        \begin{itemize}
                \resitem{Described how physics-based models can be used to predict evolutionary trajectories to the public in a 1.5 hour talk}
                \resitem{Presentation and was given to approximately 100 members of the public at Harvard Medical School}
                \resitem{Worked closely with teammates to create an effective presentation}
        \end{itemize}
\end{itemize}
...
\item \reference{Dr. David Nelson}{Professor of Physics, Applied Physics, Biophysics}{Harvard University}{Current Research Advisor}{nelson@seas.harvard.edu}{(617) 495-8852}

\item \reference{Dr. Andrew Murray}{Professor of Molecular Genetics, Molecular Cellular Biology}{Harvard University}{Current Research Advisor}{amurray@mcb.harvard.edu}{(617) 496-1350 }
