...
\begin{itemize}
\resitem{Recruited many students at career fairs through academic engagement, and drew people to CUIC team (at least 4 people hired or interned)}
\resitem{Helped save the Functional Architecture December demo for a sponsor}
\resitem{Started the AFSIM user community at MITRE, taught many courses}
\resitem{Attended AFSIM user community meeting October 2018}
\resitem{Maintained interim security clearance, obtained full secret, working on Top Secret}
\resitem{Helped to point the Functional Architecture in the correct direction. Now building it in AFSIM.}
\resitem{Gave talk at MDC2 flip the script talk to preston Dunlap and AFWIC general}
\resitem{Gave talk at AFSIM Usergroup meeting in Ohio about MITRE Platforms / MDC2 Base Types}
\resitem{Helped lead a small technical team to create AFSIM version of the FA with tight deadlines}
\resitem{Mentored Fiona Henry and Min Kim, still getting them up to speed}
\end{itemize}     
