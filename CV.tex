...
\begin{itemize}
	...
	\resitem{Learned how to perform biological experiments in Dr. Andrew Murray's lab}
	\resitem{Captured images via fluorescent microscopy; utilized Python and ImageJ extensively for analysis}
	\resitem{Analyzed and visualized extremely large sets of biological data}
	\resitem{Created simulations in Python and C++ to model range expansions}
\end{itemize}
...
\begin{itemize}
	...
	\resitem{Learned how to use a tissue culture room and grew multiple tumor cell lines}
	\resitem{Imaged tumors using standard microscopy techniques; used ImageJ to determine their sizes}
	\resitem{Installed and maintained an OMERO image analysis server to help store and quantify images}
\end{itemize}
...
\begin{itemize}
	...
	\resitem{Created simulation in C++ to model droplet motion and compared it with experimental results}
\end{itemize}
...
\resitem{Secondary Field in Computational Science and Engineering program as part of PhD}
	\begin{itemize}
...
\resitem{Biology:}
\begin{itemize}
	\resitem{Basic wet-lab experience}
	\resitem{Basic tissue culture room experience}
\end{itemize}
...
\resitem{Basic knowledge of using Bayesian inference in data analysis}
...
\item \reference{Dr. David Nelson}{Professor of Physics, Applied Physics, Biophysics}{Harvard University}{Research Advisor}{http://www.seas.harvard.edu/directory/nelson}{nelson@seas.harvard.edu}{(617) 495-8852}

\item \reference{Dr. Andrew Murray}{Professor of Molecular Genetics, Molecular Cellular Biology}{Harvard University}{Research Advisor}{https://www.mcb.harvard.edu/mcb/faculty/profile/andrew-w-murray/}{amurray@mcb.harvard.edu}{(617) 496-1350 }
