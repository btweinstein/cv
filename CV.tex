...
GSAS Mail Center, Perkins Hall, Room 207  		& 	(585) 738-0690  \\
35 Oxford Street, Cambridge, MA 02138 &  	\href{mailto:bweinstein@fas.harvard.edu}{bweinstein@fas.harvard.edu} \\
\end{tabular*}
\\
...
\begin{itemize}
\item
	\ressubheading{Harvard University}{Cambridge, MA}{PhD in Applied Physics}{Expected May 2017}
\item
...
\resitem{\textit{Selected Languages \& Programs}:
	Mathematica, Matlab, C++, CUDA, Fortran, Java, Python, Bash, \LaTeX, OOMMF, Origin, Igor, Windows Powershell, HTML, CSS}
