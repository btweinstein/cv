...
\begin{itemize}
	...
	\resitem{Analyzed extremely large sets of biological data and created simulations to aid in scientific understanding}
\end{itemize}
...
\begin{itemize}
	\resitem{Extended previous microbial model to predict how spherical tumors respond to pairwise combinations of drugs}
	\resitem{Learned how to use a tissue culture room and grew several tumor cell lines in 96 well plates}
	\resitem{Imaged the tumors using standard microscopy techniques and used ImageJ to determine their sizes}
	\resitem{Installed and maintained an OMERO image analysis server to help store and quantify the images}
\end{itemize}
...
\begin{itemize}
	...
	\resitem{Tracked motion of hundreds of randomly moving, merging droplets using ImageJ}
