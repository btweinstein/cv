...
\begin{itemize}
\item Recruited many students at career fairs through academic engagement, and drew people to CUIC team (at least 4 people hired or interned)
\item Helped save the Functional Architecture December demo for a sponsor
\item Started the AFSIM user community at MITRE, taught many courses
\item Attended AFSIM user community meeting October 2018
\item Maintained interim security clearance, obtained full secret, working on Top Secret
\item Helped to point the Functional Architecture in the correct direction. Now building it in AFSIM.
\end{itemize}     
