...
\resitem{Heavy emphasis on analytically solving and simulating spatial stochastic differential equations coupled to transport (fluid flow), and using results to inform experiments}
...
\item Led key part of division's military work program; utilized modeling and simulation to inform government decisions about distributed command and control (C2) of assets across domains
\begin{itemize}
