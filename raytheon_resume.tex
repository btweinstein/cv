...
\item Proposed and procured over two million dollars in internal research funding to build and deploy an all-domain next-gen C4 prototype; used prototype to solve directly funded government problems \begin{itemize}

\item Tested prototype with all-domain AFSIM simulations in distributed live-virtual-constructive (LVC) experiments at the TS/SCI level
...
\item Developed widely used MITRE repositories; presented at national AFSIM user group conferences 
\end{itemize}
...
\begin{itemize}
\resitem{Awarded for demonstrating tenacity over the past five years; led a large team to enable distributed LVC experimentation at the classified level through a next-gen C4 prototype
}
\end{itemize}
