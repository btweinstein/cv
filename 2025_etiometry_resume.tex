...
\item Utilized state estimation techniques such as Kalman-Filters for space-based tracking of moving objects; wrote whitepapers involving the master equation, defective renewal theory (ruin theory), and continuous-time random walks with anomalous waiting times.
