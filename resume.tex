...
\resitem{Utilized fluid and solid mechanics to model and simulate microbial colony morphology}
...
\skillitem{During my PhD, I developed over 30 GitHub repositories and wrote hundreds of Jupyter/IPython notebooks to analyze my experimental data and to create scientific simulations (see my website above)}
...
\skillitem{Expert knowledge of stochastic techniques to model and solve high-dimensional problems}

\skillitem{Used Jupyter/IPython Notebooks almost every day of my PhD to analyze, visualize, and explore my experimental data}

\skillheader{Languages for General Scientific Computing:}
\begin{itemize}
\skillitem{Python, Cython, OpenCL, CUDA, C, C++, Java, Matlab, Mathematica}
\end{itemize}
...
\begin{itemize}
\skillitem{Expert at creating simple mathematical models to describe physical phenomena}
