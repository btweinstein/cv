...
\resitem{Applied spatial stochastic differential equations to model the evolutionary dynamics of growing microbial colonies}
\resitem{Developed over 30 Github repositories focused on analyzing and efficiently simulating my experiments}
\resitem{Applied nonequilibrium statistical mechanics to better understand }
...
\end{itemize}
\resitem{Fluid Mechanics Simulations:}
\begin{itemize}
...
\begin{itemize}
\resitem{4 years of research in an experimental biology laboratory; experienced at designing and conducting experiments} 
