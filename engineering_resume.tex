...
\skillitem{Ability to mesh and simulate fluid flows containing chemical reactions using standard open-source tools (OpenFOAM) or custom-built GPU-powered Lattice Boltzmann tools}
