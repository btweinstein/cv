...
\resitem{Designed microbial experiments in complex fluids and materials; applied stochastic, random-walk methods (spatial stochastic differential equations) to model the evolutionary dynamics of observed colony growth}
...
\resitem{Significant experience using microscopy to image microbial colonies and using computational tools to analyze the images}
\end{myitemize}
