...
\begin{myitemize}
\skillitem{Deep understanding of transport in all forms (mass, momentum, energy/heat) and ability to simulate it it using standard finite volume CFD techniques or Lattice Boltzmann techniques}
\skillitem{Ability to mesh and simulate fluid flows and reaction-diffusion problems using standard open-source tools such as OpenFOAM, gmsh, and Salome or custom-built tools such as my GPU-powered Lattice-Boltzmann simulation}
\skillitem{Experience simulating multiphase flows using Lattice Boltzmann}
...
\begin{myitemize}
\resitem{Experienced at designing and conducting biological and soft matter experiments involving complex fluids;
4 years of research in a molecular biology laboratory}
\resitem{Experienced at using rheometers to determine the rheology of fluids}
