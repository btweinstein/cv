...
\resitem{Pierce Fellow: won fellowship awarded to the highest caliber PhD students accepted into Harvard's School of Engineering and Applied Sciences (SEAS). Selected out of 150 students; 8 fellowships awarded}

\resitem{Department of Energy Office of Science Graduate Fellowship: wrote proposal to win a competitive fellowship that supports students pursuing training in areas relevant to Department of Energy (DOE). Selected out of 1,300 applicants; 50 fellowships awarded}

\resitem{Thesis emphasized analytic solutions and simulating probabilistic chemical reactions (spatial stochastic differential equations) coupled to transport using custom built solvers}
