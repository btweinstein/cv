...
\resitem{Heavy emphasis on analytic solutions and simulating probabilistic chemical reactions (spatial stochastic differential equations) coupled to fluid flow using custom built solvers}
\end{itemize}
