...
\begin{itemize}
\item One of CUIC's (Cross-Cutting Urgent Innovation Cell) first external hires
\end{itemize}
\item Recognized as one of MITRE's most experienced AFSIM (popular GOTS M\&S software) developers. Created MITRE's AFSIM user group in 2018 that now has over 400 members; developed widely used MITRE repositories

\item Cohered over two million dollars in IR\&D funding in conjunction with direct work over four years to build a next-gen C4 prototype 

\begin{itemize}
\item Presented multiple times at MITRE Research and Technology (R\&T) meetings for hundreds of government sponsors.

\item Work continues under ACCEL C2 lab; working to procure eight million dollar investment in classified lab from MITRE executive leadership.
