...
\begin{itemize}
\item Rapidly developed innovative solutions to whole-of-goverment national security problems utilizing modeling, simulation, data science, engineering, and protoptying skills developed during Physics PhD and Computational Science minor

\item Presented results to senior goverment stakeholders across the DOD to deliver maximum impact

\item Mentored 10s of staff and led diverse small-to-large teams across classification levels to produce high quality and timely deliverables for goverment stakeholders
\begin{itemize}
\item One of the first members of CUIC: Cross-Cutting Urgent Innovation Cell
\end{itemize}
\item Recognized as one of MITRE's most experienced AFSIM (popular GOTS M\&S software) developers. Started MITRE's AFSIM usergroup six years ago that now has over 400 members; developed many widely used MITRE repositories
