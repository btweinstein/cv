...
\begin{itemize}
\item Rapidly developed innovative solutions to whole-of-goverment national security problems utilizing modeling, simulation, engineering, data science, and prototyping skills developed during Physics PhD with a Computational Science minor
...
\item Mentored 10s of staff and led diverse small-to-large teams across classification levels to produce high quality and timely deliverables for government stakeholders
\begin{itemize}
...
\item Led over 2 million dollars in IR\&D funding over 4 years to build a next-gen-C4 prototype that could be tested by real, simulated, or live data to accelerate deployment. Presented multiple times at MITRE Research and Technology (R\&T) meetings (100's of government sponsors). Work continues under ACCEL C2 lab; asking for 8 million dollar investment in physical space from MITRE executive leadership.
\end{itemize}
\end{itemize}
...
\begin{myitemize}
\skillitem{AFSIM, pymission, SBSS, C2S, \textit{many} custom MITRE AFSIM/Python packages}
\end{myitemize}
...
\begin{myitemize}
\skillitem{Docker, CI/CD, GitLab, Django, REST APIs, Flask, FastAPI, JIRA}
\end{myitemize}
...
\begin{myitemize}
\resitem{Adept at designing and conducting biological and soft matter experiments involving complex fluids and materials; four years of research in a molecular biology laboratory}
\resitem{Expertise in use of rheometers to quantify fluid rheology, microscopy to image microbial colonies, and computational tools to analyze images }
\end{myitemize}
