...
\begin{itemize}
\item Rapidly developed innovative solutions to whole-of-government national security problems utilizing modeling, simulation, engineering, data science, and prototyping skills
...
\end{itemize}
\item Recognized as one of MITRE's most experienced AFSIM (popular GOTS M\&S software) developers. Created MITRE's AFSIM user group in 2018 that now has over 400 members; developed many widely used MITRE repositories

\item Cohered over two million dollars in IR\&D funding over four years to build a next-gen C4 prototype that could be tested by real, simulated, or live data to accelerate deployment. Presented multiple times at MITRE Research and Technology (R\&T) meetings for hundreds of government sponsors. Work continues under ACCEL C2 lab; asking for eight million dollar investment in physical space from MITRE executive leadership.
...
\begin{itemize}
\resitem{Awarded for demonstrating tenacity over the last five years; led a large team to enable distributed experimentation at the classified level through a next-gen C4 prototype (Functional Architecture).
}
\end{itemize}
...
\resitem{Acknowledged our team's work rapidly creating an exemplar of what a JADC2 prototype could like for the Air Force Secretary of Defense under a tight deadline}
\end{itemize}
