...
\begin{itemize}
\item One of CUIC's (Cross-Cutting Urgent Innovation Cell) first hires; helped train staff
\end{itemize}
\item Recognized as one of MITRE's most experienced AFSIM (popular GOTS M\&S software) developers
\begin{itemize}
\item Created MITRE's AFSIM user group in 2018 that now has over 400 members
\item Developed widely used MITRE repositories
\end{itemize}
...
\item Work continues under ACCEL C2 lab; working to procure eight million dollar investment for classified lab from MITRE executive leadership
...
\begin{myitemize}
\skillitem{Docker, CI/CD, GitLab, git, Django, REST APIs, Flask, FastAPI, Pydantic, JIRA, Nexus Registries, VS Code, PyCharm, vim, emacs}
\end{myitemize}
