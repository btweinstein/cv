...
\begin{itemize}
\item Rapidly developed innovative solutions to whole-of-goverment national security problems utilizing modeling, simulation, engineering, data science, and prototyping skills developed during Physics PhD and Computational Science minor

\item Presented results to senior government stakeholders across the DOD to deliver maximum impact
...
\end{itemize}
\item Recognized as one of MITRE's most experienced AFSIM (popular GOTS M\&S software) developers. Started MITRE's AFSIM user group six years ago that now has over 400 members; developed many widely used MITRE repositories

\item Led over 2 million dollars in IR\&D funding over 4 years to build a next-gen-C4 prototype that could be tested by real, simulated, or live data to accelerate deployment. Presented multiple times at MITRE Research and Technology (R\&T) meetings (100's of government sponsors). Work is continuing under ACCEL C2 lab; asking for 8 million dollar investment in physical space from MITRE executive leadership.
\end{itemize}
\end{itemize}
...
\begin{itemize}
\resitem{Conducted experiments to study microbial colony growth on the surface of complex fluids and materials; applied stochastic, random-walk methods  to model colony evolutionary dynamics}
