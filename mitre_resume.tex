...
\begin{itemize}
\item Led teams to rapidly develop innovative solutions to whole-of-government national security problems utilizing modeling, simulation, engineering, data science, and prototyping skills developed during Physics PhD with a Computational Science minor
...
\item Won many MITRE internal awards (breakthrough, catalyst, spark, etc.)
\end{itemize}
\end{itemize}
