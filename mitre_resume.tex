...
\begin{itemize}
\item Rapidly developed innovative solutions to whole-of-government national security problems utilizing modeling, simulation, engineering, data science, and prototyping skills acquired during Physics PhD and Computational Science minor
...
\item Mentored dozens of staff and led diverse small-to-large teams across classification levels to produce high quality and timely deliverables for government stakeholders
\begin{itemize}
\item One of the first members of CUIC: Cross-Cutting Urgent Innovation Cell
\end{itemize}
\item Recognized as one of MITRE's most experienced AFSIM (popular GOTS M\&S software) developers. Created MITRE's AFSIM user group six years ago that now has over 400 members; developed many widely used MITRE repositories

\item Led over 2 million dollars in IR\&D funding over 4 years to build a next-gen C4 prototype that could be tested by real, simulated, or live data to accelerate deployment. Presented multiple times at MITRE Research and Technology (R\&T) meetings for hundreds of government sponsors. Work continues under ACCEL C2 lab; asking for 8 million dollar investment in physical space from MITRE executive leadership.

\item Won many MITRE internal awards (5 spark, 1 catalyst, 3 trailblazer, and 1 breakthrough award)
\end{itemize}
\end{itemize}
...
\begin{itemize}                   
\resitem{Learned state-of-the-art computational methods used in scientific research and data science; completed advanced applied math and scientific computing courses}
\resitem{\textbf{Capstone:} Developed an award-winning OpenCL (GPU) powered Lattice Boltzmann fluid mechanics simulation utilizing OpenGL for real-time visualization.}
\end{itemize}     
...
\begin{itemize}
\resitem{Recognized my tenacity over the last 5 years leading a large team to enable distributed experimentation at the classified level through a next-gen C4 prototype (Functional Architecture).
}
\end{itemize}
...
\begin{itemize}
\resitem{Celebrated our team's ability to deliver a prototype  of an API Gateway to the Chief Data and Artificial Intelligence Office (CDAO) in response to a quick-turn two week request}
\end{itemize}

\item \award{Trailblazer Award: Digital Twin JWICS deployment}{May 2022}
\begin{itemize}
\resitem{Recognized our accomplishment of linking our next-gen C4 prototype to a classified dashboard using a series of Open APIs, and demonstrated this capability during MITRE's Research and Technology (R\&T) showcase to hundreds of government sponsors}
\end{itemize}
...
\resitem{Recognized our team's work trying to rapidly produce an exemplar of what a JADC2 prototype could like for the Air Force Secretary of Defense under an extremely tight deadline}
\end{itemize}
